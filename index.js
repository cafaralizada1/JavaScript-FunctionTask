...
//     let object = arr.find(item => item.id == n)
//     console.log(object.shipAddress.country)
//   }
//   myFunction(11061)
...
// function myFunction (qwerty){
//     let object = arr.filter(item => item.shipAddress.country == qwerty)
//     console.log(object);
// }
...
//     let object = arr.find(item => item.id == hello)
//     console.log(object.shipName,object.shipAddress.country,object.shipAddress.city);
// }
...
// function myFunction (swp202){
//     let object = arr.find(item => item.id == swp202)
//     console.log(object.details.length);
// }
...
function myFunction (sumqayit){
    let object = arr.find(item => item.id == sumqayit)
    let totalprice = 0
    object.details.forEach(item =>{
        totalprice += (1 - item.discount)*(item.quantity)*(item.unitPrice)
    })
